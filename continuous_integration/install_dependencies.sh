...
if [[ "$PYTHON_VERSION" == "3.6" ]]; then
  conda install scipy=1.3 numpy=1.16 mkl pip pytest lapack ecos scs osqp flake8 cvxopt pyscipopt coincbc
  ...
  conda install scipy=1.5 numpy=1.19 mkl pip pytest lapack ecos scs osqp flake8 cvxopt pyscipopt coincbc
fi
